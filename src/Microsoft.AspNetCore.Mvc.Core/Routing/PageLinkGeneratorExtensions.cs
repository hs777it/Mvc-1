...
namespace Microsoft.AspNetCore.Routing
{
    ...
    public static class PageLinkGeneratorExtensions
    {
        ...
        /// </param>
        /// <param name="values">The route values. Optional. Used to resolve endpoints and expand parameters in the route template. Optional.</param>
        /// <param name="pathBase">
        ...
        {
            // see: https://github.com/aspnet/Routing/issues/810
            return httpContext?.Features.Get<IRouteValuesFeature>()?.RouteValues ?? new RouteValueDictionary();
        }
    }
}